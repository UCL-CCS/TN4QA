...
def noise_data() -> NoiseData:
    ...
    qubit_noise = [QubitNoise(id=0, t1_ns=43410.1770669608, t2_ns=5546.754503249878, readout_p0=0.9775, readout_p1=0.9775, gates_1q={'r': 0.9990007041848946}, gates_2q={1: 0.9902274607474589, 3: 0.9918029054337629}), 
                   ...
                   QubitNoise(id=5, t1_ns=42426.53364451025, t2_ns=1975.0477210107958, readout_p0=0.96625, readout_p1=0.96625, gates_1q={'r': 0.997301056191781}, gates_2q={4: 0.9923906053302095, 6: 0.9928115849011512}), 
                   QubitNoise(id=6, t1_ns=49154.75800608243, t2_ns=4524.78153423451, readout_p0=0.985, readout_p1=0.985, gates_1q={'r': 0.9990077404534111}, gates_2q={5: 0.9928115849011512}), 
                   QubitNoise(id=7, t1_ns=45710.784280755084, t2_ns=2319.844285109669, readout_p0=0.982, readout_p1=0.982, gates_1q={'r': 0.998575519612879}, gates_2q={2: 0.9924136510683637, 8: 0.990161462057128}), 
                   QubitNoise(id=8, t1_ns=34033.12093913222, t2_ns=5793.71725560215, readout_p0=0.9825, readout_p1=0.9825, gates_1q={'r': 0.9981202652492177}, gates_2q={3: 0.9911723862393091, 7: 0.990161462057128, 9: 0.9935597545907197}), 
                   QubitNoise(id=9, t1_ns=34626.08700454571, t2_ns=4057.278698798379, readout_p0=0.9735, readout_p1=0.9735, gates_1q={'r': 0.9985727377738376}, gates_2q={4: 0.9922840549492525, 8: 0.9935597545907197})] 
